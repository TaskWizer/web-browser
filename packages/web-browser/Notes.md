...
Next steps:
Priority 2: Performance Optimization (code splitting, PDF/EPUB testing)
Priority 3: UI/UX Enhancements (drag-and-drop, glow effect)
Priority 4: Code Quality improvements
Priority 5: Ad Blocking feature


Typing "Google" into the search bar and pressing CTRL+Enter results is browsing to "https://www.google.com" (assumes .com).

The address bar is glowing, but it should be the chat input box.
Cannot drag and drop bookmark icons in the bookmarks bar.
